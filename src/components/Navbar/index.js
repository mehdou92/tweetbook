      ...
      <div class="flex-1">
        <nav class="flex items-center justify-between flex-wrap bg-gray-800 p-6">
          ...
          <div class="block lg:hidden">
            <button class="flex items-center px-3 py-2 border rounded text-bluegit-500 border-blue-500 hover:text-blue-700 hover:border-blue-700">
              <svg class="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path fill="#4299e1" d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z" /></svg>
            </button>
          </div>
            ...
            <div class="text-sm lg:flex-grow flex">
              ...
              </Link>
              {
                isLoading
                  ...
                  <>
                    <Link to="/login">
                    <button class="flex hover:bg-blue-900 text-blue-500 font-semibold py-2 px-4 rounded">
                      Login
